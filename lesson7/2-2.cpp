...
using namespace std;
#define Error 1e-6
void RK3(double ta,double tb,double y0,int M);//3级龙格库塔R-K法
...
//3级R-K法(Kutta法)
void RK3(double ta,double tb,double y0,int m)
{
    double h=1/pow(2,m),t0=ta,k1,k2,k3;
